...
2. Integrate an OS credential vault without ever writing bearer or recovery secrets to the repository.
3. Add release signing, installer generation, and CI publishing.
4. Define whether an operator-only authorization capability is needed beyond authenticated plan confirmation for destructive maintenance.
